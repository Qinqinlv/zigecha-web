...
///MYSQLHelper 的摘要说明
/// </summary>
public abstract class MySqlAccessHelper
{
    //数据库连接字符串
    //public static string Conn = "Database='ant_data';Data Source='localhost';;port=3307;User Id='root';Password='root';charset='utf8';pooling=true;SslMode=none";
